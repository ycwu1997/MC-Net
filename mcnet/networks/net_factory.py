...
from networks.VNet import VNet, MCNet3d_v1, MCNet3d_v2, MCNet3d_v3
...
def net_factory(net_type="unet", in_chns=1, class_num=4, mode = "train"):
    ...
    elif net_type == "mcnet3d_v3" and mode == "train":
        net = MCNet3d_v3(n_channels=in_chns, n_classes=class_num, normalization='batchnorm', has_dropout=True).cuda()
    ...
    elif net_type == "mcnet3d_v3" and mode == "test":
        net = MCNet3d_v3(n_channels=in_chns, n_classes=class_num, normalization='batchnorm', has_dropout=False).cuda()
    return net
